  ...
  <div>
    <UForm :state="state" class="space-y-4">
      ...
      <UFormField v-if="hasContact" :label="t('contact')" name="contact">
        ...
        <UButton
          v-if="state.contact.email" icon="i-heroicons-envelope" color="primary" variant="link"
          :label="state.contact.email" :to="state.contact.email"
        />
        <UButton
          v-if="state.contact.telephone" icon="i-heroicons-phone" color="primary" variant="link"
          :label="state.contact.telephone" :to="state.contact.telephone"
        />
        <UButton
          v-if="state.contact.fax" icon="i-heroicons-printer" color="primary" variant="link"
      ...
      <UFormField v-if="hasSocials" :label="t('socials')" name="socials">
        <UButton
          v-if="state.socials.facebook" icon="i-simple-icons-facebook" color="primary" variant="link"
          label="Facebook" :to="state.socials.facebook"
        />
        <UButton
          v-if="state.socials.instagram" icon="i-simple-icons-instagram" color="primary" variant="link"
          label="Instagram" :to="state.socials.instagram"
        />
        <UButton
          v-if="state.socials.youtube" icon="i-simple-icons-youtube" color="primary" variant="link"
          label="YouTube" :to="state.socials.youtube"
        />
        <UButton
          v-if="state.socials.twitter" icon="i-simple-icons-x" color="primary" variant="link" label="X"
          :to="state.socials.twitter"
        />
        <UButton
          v-if="state.socials.tikTok" icon="i-simple-icons-tiktok" color="primary" variant="link" label="TikTok"
